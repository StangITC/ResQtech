...
const char* WIFI_PASS = "12345678";  // ใส่รหัสผ่าน WiFi

// API Settings (ตั้งค่าการเชื่อมต่อ Server)
// ตรวจสอบ IP Address ของเครื่องคอมพิวเตอร์ที่รัน ResQTech (ใช้คำสั่ง ipconfig ใน cmd)
const char* SERVER_URL = "http://192.168.1.111/ResQtechApp/api/esp32-receiver.php"; 
...
const unsigned long HEARTBEAT_INTERVAL = 5000; // ส่ง Heartbeat ทุก 5 วินาที
const unsigned long DEBOUNCE_DELAY     = 10;   // ป้องกันการกดปุ่มซ้ำ (ms)
